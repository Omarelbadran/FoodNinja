...
import 'package:food_ninja/views/auth_views/payment_method_view.dart';
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Align(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        ...
                        color: Color(0xffF9A84D).withValues(alpha: .2),
                      ),
                      width: 40.w,
                      height: 35.h,
                  ...
                  SizedBox(height: screenHeight * .02,),
                  CustomTextFromField(hintText: 'First Name'),
                  SizedBox(height: screenHeight * .02,),
                  CustomTextFromField(hintText: 'Last Name'),
                  SizedBox(height: screenHeight * .02,),
                  CustomTextFromField(hintText: 'Phone Number'),
